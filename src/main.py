...
PROJECT = {
  "code": "P10",
  "slug": "dice-large-numbers-lab",
  "title": "Dice Large Numbers Lab",
  ...
  "kind": "dice",
  "dataset": "Generated dice-roll simulation",
  "source": "Local deterministic generation",
  "description": "Probability simulation lab showing relative frequency convergence for dice rolls.",
  "concepts": [
    "random.randint",
    "lists",
    "loops",
