...
PROJECT = {
  ...
  "title": "Simulacao De Dados E Lei Dos Grandes Numeros",
  ...
  "description": "Simulacao de rolagens e convergencia de frequencia relativa para introduzir probabilidade.",
  "topics": [
    "data-science",
    "python",
    "jupyter-notebook",
